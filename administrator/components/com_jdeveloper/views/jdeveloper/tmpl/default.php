...
<div id="j-main-container" class="span9">
	<div class="row-fluid">
		<div class="span12">
		<h2><?php echo JText::_("COM_JDEVELOPER_JDEVELOPER_VERSION_CHECK") ?></h2>
...
<!--
	<div class="row-fluid">
		<div class="span12">
		<div class="thumbnails ph-icon">
			<a class="thumbnail ph-icon-inside" href="index.php?option=com_phocadownload&view=phocadownloadfiles">
				<img src="<?php echo JURI::base(true);?>/../media/com_jdeveloper/images/component.png" alt="<?php echo JText::_("COM_JDEVELOPER_COMPONENTS"); ?>"/>
				<br/>
				<span><?php echo JText::_("COM_JDEVELOPER_COMPONENTS"); ?></span>
			</a>
		</div>
		</div>
	</div>
-->
	<div class="row-fluid">
		<div class="span12">
			<h2><?php echo JText::_("COM_JDEVELOPER_JDEVELOPER_HEADLINE_ARCHIVES") ?></h2>
